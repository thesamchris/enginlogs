            ...
            <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%">
            	<tr>
            		<td style="padding: 0 2.5em; text-align: left;">
            			<div class="text">
            				<h2>${data.bookingId}, ${data.email}, here is the summary of items</h2>
            				<h3>Loaned from ${data.collectionDate} (${data.collectionTime}) to ${data.returnDate}(${data.returnTime})</h3>
            			</div>
            		</td>
            	</tr>
            </table>
